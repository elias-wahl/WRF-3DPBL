...
dropped --- and if dropped, what is assumed instead. Table~I.1b (added 2026-09-16) traces the nineteen rows back to the hypotheses of turbulence theory they come from --- scale separation, the Reynolds conditions, ergodicity, homogeneity, stationarity, isotropy in three forms, locality, similarity, realizability --- and shows which observation of the campaign tests each; Figure~I.1b draws the chain of reliance as a pyramid. It comes in three versions: a one-page
