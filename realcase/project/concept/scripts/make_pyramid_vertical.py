...
rep = [
 ...
 ("The moons above the formalism tier", "The moons at the far right"),
 ("rows from bottom to top", "left to right"),
...
%  GENERATED by scripts/make_pyramid_vertical.py from {SRC.name}; edit the
...
SUBTITLE = ("Vertical page of the split variant: spectral gap and gradient scale as separate premises. 2026-09-17."
            if "split" in SRC.name else "Vertical version of the companion page to the assumptions note. 2026-09-16.")
...
\end{document}
"""
DST.write_text(doc.replace("SUBTITLE_PLACEHOLDER", SUBTITLE))
