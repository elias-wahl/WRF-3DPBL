...
%  2026-09-21 (evening): homogeneity's channel through stationarity and similarity removed (Monin-Obukhov and the mixing length
%  lean on it by text and triangle); every lean weighted 3/2/1.
%  2026-09-21 (Elias's tablet notes on the block table): homogeneity's layout clause dropped from the block text; the
%  cascade names the integral scale (its lean on Mixing, previously in the source list only); for the extra line every
%  coordinate x >= 18.85 shifted +0.3 (pyramid_remap.py), cascade 1.3 wide, no contact changed.
%  2026-09-18: small-scale isotropy split at x = 20.2/20.3 into itself and the premise Weak anisotropy (Mellor & Yamada 1982,
%  p. 854: terms of order a^2 eliminated, a_ij^2 ~ 0.15 "not overly small"); Return to isotropy stands on both.
...
\lean[2]{Boundary-layer (column) approximation}{Boussinesq}
...
\lean[3]{Stability functions and cutoff}{Local equilibrium}
\lean[3]{Stability functions and cutoff}{Buoyancy production}
\lean[2]{Stability functions and cutoff}{Boundary-layer (column) approximation}
\lean[1]{Stability functions and cutoff}{Level-2.5 truncation}
\lean[1]{Stability functions and cutoff}{Universal constants}
...
\lean[3]{K-form fluxes}{Stability functions and cutoff}
...
bottom exactly the blocks it relies on, and blocks on one level do not touch each other. Three tiers. Dark grey, the ground: ten hypotheses about the fluid and the flow that rest on nothing else here; Monin--Obukhov similarity and the mixing length lean on homogeneity by text; the channel that carried it to them in earlier versions is gone (2026-09-21). Light grey, the
...
\pb{8.725}{12.275}{0}{1.7}{ground}{\textbf{Stationarity}\\ statistics invariant under time translation over the relaxation time $l/q$}
\pb{12.375}{16.65}{0}{1.7}{ground}{\textbf{Similarity}\\ one universal scaled relation in every flow; the parameter list complete}
\pb{3.1}{8.625}{0}{1.7}{ground}{\textbf{Horizontal homogeneity}\\ statistics invariant under horizontal translation: \mbox{$\partial_x\avg{\cdot} = \partial_y\avg{\cdot} = 0$} for every mean and every moment}
\pb{16.75}{20.5}{0}{1.7}{ground}{\textbf{Small-scale isotropy}\\ at high Reynolds number the small eddies forget the direction of shear and gravity}
\pb{20.6}{22.2}{0}{1.7}{ground}{\textbf{Weak anisotropy}\\ the energy-containing eddies depart only weakly from isotropy}
\pb{22.3}{23.95}{0}{1.7}{ground}{\textbf{Gradient scale}\\ the eddy small against the scale of the mean gradient}
\pb{24.05}{26.1}{0}{1.7}{ground}{\textbf{Axisymmetric mixing}\\ gravity the one axis; one $K$ along and across the shear; no handedness}
\pb{26.2}{27.9}{0}{1.7}{ground}{\textbf{Boussinesq}\\ unsaturated air; buoyancy the only density effect; incompressible}


% ---- tier 1: concepts (y 1.7 -- 3.6); 7 singles of 1.15, 4 doubles of 2.40, 2 triples of 3.65 ------

\pb{0}{1.45}{1.7}{3.6}{hyp}{\textbf{Reynolds decomposition}\\ $\avg{a'} = 0$ and $\avg{\avg{a}\,b'} = 0$:\\ true for a window only if\\ the mean does not vary across it}
...
\pb{8.1}{9.25}{1.7}{3.6}{hyp}{\textbf{Constant-flux layer}\\ fluxes keep their surface value in the boundary layer's lowest tenth}
\pb{9.35}{11.35}{1.7}{3.6}{hyp}{\textbf{Local equilibrium}\\ the eddies relax within $l/q$, faster than the flow changes along their path: second moments follow the current local gradients; tendency, advection and transport neglected}
\pb{11.45}{14.15}{1.7}{3.6}{hyp}{\textbf{Monin--Obukhov similarity}\\ in the constant-flux layer the gradients scaled by $u_*$, $\theta_*$, $z$ are universal functions of $z/L_{\mathrm{MO}}$: no other parameter; over a homogeneous, hence horizontal, surface with one roughness length}
\pb{14.25}{15.4}{1.7}{3.6}{hyp}{\textbf{Mixing length}\\ one integral scale $l$ per height, set by the column alone}
\pb{15.5}{17.8}{1.7}{3.6}{hyp}{\textbf{Universal constants}\\ the scaled rates of return to isotropy and of dissipation are pure numbers, the same in every flow: measured once in simple flows, valid everywhere}
\pb{17.9}{19.2}{1.7}{3.6}{hyp}{\textbf{Energy cascade}\\ isotropic dissipation in equilibrium with the integral-scale eddies, $\varepsilon \sim q^3/l$}
\pb{19.3}{22.1}{1.7}{3.6}{hyp}{\textbf{Return to isotropy}\\ pressure fluctuations scramble the eddies toward isotropy: anisotropy decays at the one rate $q/l$, linear in it, because it is small (Rotta), computed locally as in homogeneous turbulence away from walls; pressure transport diffusive}
\pbf{23.45}{25.1}{1.7}{3.6}{hyp}{\textbf{Eddy viscosity}\\ local gradient transport with one positive scalar $K \sim l q$, alike along and across the shear}{0.30}
\pb{22.3}{23.35}{1.7}{3.6}{hyp}{\textbf{Locality}\\ the flux answers the local gradient, $l \ll$ its scale, after decorrelation}

\pb{25.25}{27.6}{1.7}{3.6}{hyp}{\textbf{Buoyancy production}\\ gravity acts along one axis: the vertical heat flux alone exchanges kinetic and potential energy, all of it in $\avg{w^2}$; its sharing among the components is left to the return to isotropy; no horizontal heat flux}
...
\pb{9.9}{11.35}{3.6}{6.1}{row}{\textbf{Level-2.5 truncation}\\ all second moments but $\qsq$ algebraic: their tendencies and transport neglected, to leading order in the anisotropy}
\pb{11.9}{13.35}{3.6}{6.1}{row}{\textbf{Surface fluxes and first level}\\ bulk transfer between the ground and $z_1$, inside the inertial sublayer: $z_0 \ll z_1 \ll z_i$}
\pbf{13.55}{15.85}{3.6}{6.1}{row}{\textbf{Master length scale}\\ $1/L = 1/L_S + 1/L_T + 1/L_B$: wall distance with $\zeta$, one $z_i$ per column, $q/N$ from the buoyancy term; blind to terrain and grid}{0.44}
\pb{16.05}{17.2}{3.6}{6.1}{row}{\textbf{Constant set}\\ one set, fitted in neutral and convective air over flat terrain}
\pb{17.35}{18.8}{3.6}{6.1}{row}{\textbf{One length for $K$ and $\varepsilon$}\\ $\varepsilon = q^3/(B_1 L)$, isotropic, one rate; the same $L$ as in $K = lqS$, from the master length}
\pb{19.3}{20.45}{3.6}{6.1}{row}{\textbf{Pressure terms}\\ Rotta return, $A_1$; isotropised production, $C_1$; TKE transport down-gradient, $S_q$}
\pbf{20.6}{22.1}{3.6}{6.1}{row}{\textbf{Stability functions and cutoff}\\ $S_M$, $S_H$ from the balance $P_s + P_b = \varepsilon$\\ in the vertical Ri alone; cutoff at $\Rfc$}{0.44}
\pbf{22.3}{25.1}{3.6}{6.1}{row}{\textbf{K-form fluxes}\\ local and down-gradient, each flux from the gradient of its own mean: \mbox{$\avg{uw} = -K_M\,U_z$}, \mbox{$\avg{w\theta} = -K_H\,\Theta_z$}; one scalar $K$ in every direction, aligned with the gradient; one $K_H$ for all scalars. This closure's $K = lqS$: $l$ from the master length, $S$ from the stability functions}{0.30}

\pb{25.3}{27.6}{3.6}{6.1}{row}{\textbf{Buoyancy term}\\ $P_b = \beta g\,\avg{w\theta_v}$ of unsaturated air, $\beta = 1/300$~K; no horizontal heat flux; $\avg{w\theta_v}$ from the K-form}
...
\node[inner sep=0pt] at (10.625,6.45) {\color{cMYNN}\gK};
\node[inner sep=0pt] at (10.625,6.80) {\color{cGXIX}\gK};
\node[inner sep=0pt] at (10.625,7.15) {\color{cAPPROX}\gK};
\node[inner sep=0pt] at (10.625,7.50) {\color{cFULL}\gK};
\node[inner sep=0pt] at (21.350,6.45) {\color{cMYNN}\gD};
\node[inner sep=0pt] at (21.350,6.80) {\color{cGXIX}\gP};
\node[inner sep=0pt] at (21.350,7.15) {\color{cAPPROX}\gK};
\node[inner sep=0pt] at (21.350,7.50) {\color{cFULL}\gP};
\node[inner sep=0pt] at (12.625,6.45) {\color{cMYNN}\gK};
\node[inner sep=0pt] at (12.625,6.80) {\color{cGXIX}\gK};
\node[inner sep=0pt] at (12.625,7.15) {\color{cAPPROX}\gK};
\node[inner sep=0pt] at (12.625,7.50) {\color{cFULL}\gK};
\node[inner sep=0pt] at (14.700,6.45) {\color{cMYNN}\gK};
\node[inner sep=0pt] at (14.700,6.80) {\color{cGXIX}\gP};
\node[inner sep=0pt] at (14.700,7.15) {\color{cAPPROX}\gK};
\node[inner sep=0pt] at (14.700,7.50) {\color{cFULL}\gK};
\node[inner sep=0pt] at (16.625,6.45) {\color{cMYNN}\gK};
\node[inner sep=0pt] at (16.625,6.80) {\color{cGXIX}\gK};
\node[inner sep=0pt] at (16.625,7.15) {\color{cAPPROX}\gK};
\node[inner sep=0pt] at (16.625,7.50) {\color{cFULL}\gK};
\node[inner sep=0pt] at (18.075,6.45) {\color{cMYNN}\gK};
\node[inner sep=0pt] at (18.075,6.80) {\color{cGXIX}\gK};
\node[inner sep=0pt] at (18.075,7.15) {\color{cAPPROX}\gK};
\node[inner sep=0pt] at (18.075,7.50) {\color{cFULL}\gK};
\node[inner sep=0pt] at (19.875,6.45) {\color{cMYNN}\gK};
\node[inner sep=0pt] at (19.875,6.80) {\color{cGXIX}\gK};
\node[inner sep=0pt] at (19.875,7.15) {\color{cAPPROX}\gK};
\node[inner sep=0pt] at (19.875,7.50) {\color{cFULL}\gK};
\node[inner sep=0pt] at (23.700,6.45) {\color{cMYNN}\gP};
\node[inner sep=0pt] at (23.700,6.80) {\color{cGXIX}\gP};
\node[inner sep=0pt] at (23.700,7.15) {\color{cAPPROX}\gP};
\node[inner sep=0pt] at (23.700,7.50) {\color{cFULL}\gD};
\node[inner sep=0pt] at (26.450,6.45) {\color{cMYNN}\gP};
\node[inner sep=0pt] at (26.450,6.80) {\color{cGXIX}\gP};
\node[inner sep=0pt] at (26.450,7.15) {\color{cAPPROX}\gP};
\node[inner sep=0pt] at (26.450,7.50) {\color{cFULL}\gP};
% ---- end moons ----
...
\hl{20.6}{22.1}{3.6}{6.1}{cFULL}{0.05}\hl{20.6}{22.1}{3.6}{6.1}{cGXIX}{0.14} % stability functions and cutoff
\hl{13.55}{15.85}{3.6}{6.1}{cFULL}{0.05}\hl{13.55}{15.85}{3.6}{6.1}{cGXIX}{0.14} % master length scale
\hl{23.45}{25.1}{1.7}{3.6}{cFULL}{0.05}   % eddy viscosity (3D only)
\hl{22.3}{25.1}{3.6}{6.1}{cFULL}{0.05}   % K-form fluxes (3D only)
