...
\pb{0.4}{1.45}{1.7}{3.6}{hyp}{\textbf{Reynolds averaging}\\ mean plus fluctuation; the averaging rules hold}
\pb{1.55}{4.25}{1.7}{3.6}{hyp}{\textbf{Ergodicity in space}\\ the cell mean converges to the ensemble mean: many decorrelated eddies per cell, \mbox{$\Delta \gg l$}, alike across it}
...
\pb{9.35}{11.05}{1.7}{3.6}{hyp}{\textbf{Local equilibrium}\\ second moments follow the current local gradients}
\pb{11.15}{13.85}{1.7}{3.6}{hyp}{\textbf{Monin--Obukhov similarity}\\ universal flux--profile relations in $z/L_{\mathrm{MO}}$ over a homogeneous, hence horizontal, surface: one Obukhov length, one roughness length}
\pb{13.95}{15.1}{1.7}{3.6}{hyp}{\textbf{Mixing length}\\ one eddy size from the column's vertical structure}
\pb{15.2}{17.5}{1.7}{3.6}{hyp}{\textbf{Universal constants}\\ the rates of return to isotropy and of dissipation are the same ensemble numbers in every flow}
...
\pb{18.7}{21.5}{1.7}{3.6}{hyp}{\textbf{Return to isotropy}\\ pressure--strain relaxes anisotropy at one rate, linear in it (Rotta); pressure transport diffusive}
\pbf{22.85}{24.5}{1.7}{3.6}{hyp}{\textbf{Eddy viscosity}\\ gradient transport with one scalar $K \sim l q$, the same along and across the shear}{0.30}
\pb{21.7}{22.75}{1.7}{3.6}{hyp}{\textbf{Locality}\\ the flux answers the local gradient, $l \ll$ its scale, after decorrelation}

\pb{24.65}{27}{1.7}{3.6}{hyp}{\textbf{Buoyancy production}\\ buoyancy acts on TKE through the vertical heat flux alone; no redistribution among the stress components}
