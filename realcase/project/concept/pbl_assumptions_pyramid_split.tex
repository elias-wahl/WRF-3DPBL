...
\pb{16.75}{20.2}{0}{1.7}{ground}{\textbf{Small-scale isotropy}\\ at high Reynolds number the small eddies forget the direction of shear and gravity}
\pb{20.3}{21.9}{0}{1.7}{ground}{\textbf{Weak anisotropy}\\ the energy-containing eddies depart only weakly from isotropy}
\pb{22}{23.65}{0}{1.7}{ground}{\textbf{Gradient scale}\\ the eddy small against the scale of the mean gradient}
\pb{23.75}{25.8}{0}{1.7}{ground}{\textbf{Axisymmetric mixing}\\ gravity the one axis; one $K$ along and across the shear; no handedness}
\pb{25.9}{27.6}{0}{1.7}{ground}{\textbf{Boussinesq}\\ unsaturated air; buoyancy the only density effect; incompressible}
...
\pb{17.9}{18.9}{1.7}{3.6}{hyp}{\textbf{Energy cascade}\\ isotropic dissipation in equilibrium with the large eddies, $\varepsilon \sim q^3/l$}
\pb{19}{21.8}{1.7}{3.6}{hyp}{\textbf{Return to isotropy}\\ pressure fluctuations scramble the eddies toward isotropy: anisotropy decays at the one rate $q/l$, linear in it, because it is small (Rotta), computed locally as in homogeneous turbulence away from walls; pressure transport diffusive}
\pbf{23.15}{24.8}{1.7}{3.6}{hyp}{\textbf{Eddy viscosity}\\ local gradient transport with one positive scalar $K \sim l q$, alike along and across the shear}{0.30}
\pb{22}{23.05}{1.7}{3.6}{hyp}{\textbf{Locality}\\ the flux answers the local gradient, $l \ll$ its scale, after decorrelation}

\pb{24.95}{27.3}{1.7}{3.6}{hyp}{\textbf{Buoyancy production}\\ gravity acts along one axis: the vertical heat flux alone exchanges kinetic and potential energy, all of it in $\avg{w^2}$; its sharing among the components is left to the return to isotropy; no horizontal heat flux}
...
\pb{19}{20.15}{3.6}{6.1}{row}{\textbf{Pressure terms}\\ Rotta return, $A_1$; isotropised production, $C_1$; TKE transport down-gradient, $S_q$}
\pbf{20.3}{21.8}{3.6}{6.1}{row}{\textbf{Stability functions and cutoff}\\ $S_M$, $S_H$ from the balance $P_s + P_b = \varepsilon$\\ in the vertical Ri alone; cutoff at $\Rfc$}{0.44}
\pbf{22}{24.8}{3.6}{6.1}{row}{\textbf{K-form fluxes}\\ local and down-gradient, each flux from the gradient of its own mean: \mbox{$\avg{uw} = -K_M\,U_z$}, \mbox{$\avg{w\theta} = -K_H\,\Theta_z$}; one scalar $K$ in every direction, aligned with the gradient; one $K_H$ for all scalars. This closure's $K = lqS$: $l$ from the master length, $S$ from the stability functions}{0.30}

\pb{25}{27.3}{3.6}{6.1}{row}{\textbf{Buoyancy term}\\ $P_b = \beta g\,\avg{w\theta_v}$ of unsaturated air, $\beta = 1/300$~K; no horizontal heat flux; $\avg{w\theta_v}$ from the K-form}
...
\node[inner sep=0pt] at (21.050,6.45) {\color{cMYNN}\gD};
\node[inner sep=0pt] at (21.050,6.80) {\color{cGXIX}\gP};
\node[inner sep=0pt] at (21.050,7.15) {\color{cAPPROX}\gK};
\node[inner sep=0pt] at (21.050,7.50) {\color{cFULL}\gP};
...
\node[inner sep=0pt] at (19.575,6.45) {\color{cMYNN}\gK};
\node[inner sep=0pt] at (19.575,6.80) {\color{cGXIX}\gK};
\node[inner sep=0pt] at (19.575,7.15) {\color{cAPPROX}\gK};
\node[inner sep=0pt] at (19.575,7.50) {\color{cFULL}\gK};
\node[inner sep=0pt] at (23.400,6.45) {\color{cMYNN}\gP};
\node[inner sep=0pt] at (23.400,6.80) {\color{cGXIX}\gP};
\node[inner sep=0pt] at (23.400,7.15) {\color{cAPPROX}\gP};
\node[inner sep=0pt] at (23.400,7.50) {\color{cFULL}\gD};
\node[inner sep=0pt] at (26.150,6.45) {\color{cMYNN}\gP};
\node[inner sep=0pt] at (26.150,6.80) {\color{cGXIX}\gP};
\node[inner sep=0pt] at (26.150,7.15) {\color{cAPPROX}\gP};
\node[inner sep=0pt] at (26.150,7.50) {\color{cFULL}\gP};
% ---- end moons ----
...
\hl{20.3}{21.8}{3.6}{6.1}{cFULL}{0.05}\hl{20.3}{21.8}{3.6}{6.1}{cGXIX}{0.14} % stability functions and cutoff
\hl{13.55}{15.85}{3.6}{6.1}{cFULL}{0.05}\hl{13.55}{15.85}{3.6}{6.1}{cGXIX}{0.14} % master length scale
\hl{23.15}{24.8}{1.7}{3.6}{cFULL}{0.05}   % eddy viscosity (3D only)
\hl{22}{24.8}{3.6}{6.1}{cFULL}{0.05}   % K-form fluxes (3D only)
