...
\pb{0.68}{1.67}{3.6}{6.1}{row}{\textbf{Resolved gradient}\\ $\Delta z \ll$ the shear layer}
\pb{1.93}{5.40}{3.6}{6.1}{row}{\textbf{Grid means are ensemble means}\\ the grid spacing appears nowhere; the resolved flow is not turbulent, so its shear feeds production}
