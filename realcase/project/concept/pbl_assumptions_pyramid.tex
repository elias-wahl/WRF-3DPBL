...
\pb{0.60}{1.75}{1.7}{3.6}{hyp}{\textbf{Locality}\\ the flux answers the local gradient, $l \ll$ its scale, after many decorrelation times}
...
\pb{15.60}{16.75}{1.7}{3.6}{hyp}{\textbf{Mixing length}\\ one eddy size from the column's vertical structure: $z$, $z_i$, $N$}
...
\pbf{5.68}{6.85}{3.6}{5.9}{row}{\textbf{Vertical shear only}\\ two of nine terms; no gradient of $W$}{0.44}
\pbf{7.05}{9.17}{3.6}{5.9}{row}{\textbf{Vertical divergence only}\\ mean equations and TKE in $z$ only; TKE not advected; horizontal mixing by numerics at a separate scale, its energy lost to $\qsq$; surfaces horizontal}{0.44}
\pb{9.43}{10.95}{3.6}{5.9}{row}{\textbf{Wall value of $\qsq$}\\ $\qsq = B_1^{2/3} u_*^2$ at the ground: the neutral level-2 equilibrium of the constant-flux layer}
\pbf{11.15}{13.05}{3.6}{5.9}{row}{\textbf{Level-2.5 truncation}\\ all moments but $\qsq$ algebraic; $S_M$, $S_H$ from the level-2 balance in the vertical Ri alone; cutoff at $\Rfc$}{0.44}
\pb{13.25}{14.70}{3.6}{5.9}{row}{\textbf{Surface fluxes and first level}\\ bulk transfer between the ground and $z_1$, inside the inertial sublayer: $z_0 \ll z_1 \ll z_i$}
\pbf{14.90}{17.20}{3.6}{5.9}{row}{\textbf{Master length scale}\\ $1/L = 1/L_S + 1/L_T + 1/L_B$ with universal coefficients: wall distance with $\zeta$, one $z_i$ per column, $q/N$; the same $L$ in $K$ and $\varepsilon$; blind to terrain and grid}{0.44}
\pb{17.40}{18.40}{3.6}{5.9}{row}{\textbf{Constant set}\\ one set, fitted over flat terrain}
\pb{18.60}{20.42}{3.6}{5.9}{row}{\textbf{Dissipation}\\ $\varepsilon = q^3/(B_1 L)$: isotropic, one rate, diagnosed from the master length}
...
\hl{5.68}{6.85}{3.6}{5.9}{cFULL}{0.05}\hl{5.68}{6.85}{3.6}{5.9}{cGXIX}{0.14}     % vertical shear only
\hl{7.05}{9.17}{3.6}{5.9}{cFULL}{0.05}\hl{7.05}{9.17}{3.6}{5.9}{cGXIX}{0.14}     % vertical divergence only
\hl{11.15}{13.05}{3.6}{5.9}{cFULL}{0.05}\hl{11.15}{13.05}{3.6}{5.9}{cGXIX}{0.14} % level-2.5 truncation (cutoff)
\hl{14.90}{17.20}{3.6}{5.9}{cFULL}{0.05}\hl{14.90}{17.20}{3.6}{5.9}{cGXIX}{0.14} % master length scale
