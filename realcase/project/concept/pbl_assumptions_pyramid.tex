...
\pb{24.00}{26.50}{1.7}{3.6}{hyp}{\textbf{Buoyancy production}\\ buoyancy acts on TKE through the vertical heat flux alone; no redistribution among the stress components}
...
\pbf{4.58}{6.00}{3.6}{5.9}{row}{\textbf{Vertical shear production}\\ two of nine terms: vertical shear of $U$ and $V$; no gradient of $W$}{0.44}
\pbf{6.20}{8.22}{3.6}{5.9}{row}{\textbf{Vertical divergence only}\\ mean equations and TKE in $z$ only; TKE not advected; horizontal mixing by numerics, its energy lost to $\qsq$; surfaces horizontal}{0.44}
...
\pbf{10.45}{12.25}{3.6}{5.9}{row}{\textbf{Level-2.5 truncation}\\ all moments but $\qsq$ algebraic; $S_M$, $S_H$ from the level-2 balance in the vertical Ri alone; cutoff at $\Rfc$}{0.44}
\pb{12.45}{13.55}{3.6}{5.9}{row}{\textbf{First model level}\\ inside the inertial sublayer: $z_0 \ll z_1 \ll z_i$}
\pbf{13.75}{16.02}{3.6}{5.9}{row}{\textbf{Master length scale}\\ $1/L = 1/L_S + 1/L_T + 1/L_B$: wall distance with $\zeta$, one $z_i$ per column, $q/N$; the same $L$ in $K$ and $\varepsilon$; blind to terrain and grid}{0.44}
...
\hl{4.58}{6.00}{3.6}{5.9}{cFULL}{0.05}\hl{4.58}{6.00}{3.6}{5.9}{cGXIX}{0.14}     % vertical shear production
\hl{6.20}{8.22}{3.6}{5.9}{cFULL}{0.05}\hl{6.20}{8.22}{3.6}{5.9}{cGXIX}{0.14}     % vertical divergence only
