...
the ground: eight hypotheses about the fluid and the flow that rest on nothing else here. Light grey, the
...
B6, split because one block cannot touch three foundations. Wall value of $\qsq$: the lower boundary of the TKE equation (D6). Surface fluxes and first level: D3 with the bulk-transfer half of B6. K-form fluxes: C1, C2, C3 and the mixing of
