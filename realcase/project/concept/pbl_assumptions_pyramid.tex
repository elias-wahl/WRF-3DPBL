...
% homogeneity is a \pbunion: body, tunnel under stationarity (y < 0.35, stationarity starts at 0.45), pillar 13.45-13.95
...
\pbunion{ground}{7.11}{0.85}{5.3}{\textbf{Horizontal homogeneity}\\ statistics invariant under horizontal translation: \mbox{$\pd{\avg{\cdot}}{x} = \pd{\avg{\cdot}}{y} = 0$} for every mean and every moment}{4.35/9.875/0/1.7,9.875/13.95/0/0.35,13.45/13.95/0/1.7}{(4.35,0) -- (13.95,0) -- (13.95,1.7) -- (13.45,1.7) -- (13.45,0.35) -- (9.875,0.35) -- (9.875,1.7) -- (4.35,1.7)}
\pb{9.975}{13.35}{0.45}{1.7}{ground}{\textbf{Stationarity}\\ statistics invariant under time translation over the relaxation time $l/q$; the cascade in equilibrium}
\pb{14.05}{18.00}{0}{1.7}{ground}{\textbf{Similarity}\\ one universal scaled relation in every flow; the parameter list complete}
...
column approximation and, with stationarity, the constant-flux layer; stationarity gives local equilibrium and, with similarity and with homogeneity reaching it through an extension under stationarity, Monin--Obukhov similarity; similarity gives the mixing length and, with small-scale isotropy,
