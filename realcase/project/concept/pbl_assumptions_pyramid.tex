...
\pb{9.35}{10.50}{1.7}{3.6}{hyp}{\textbf{Constant-flux layer}\\ fluxes constant with height in the lowest tenth of the layer}
...
\pb{19.35}{20.50}{1.7}{3.6}{hyp}{\textbf{Energy cascade}\\ Kolmogorov: isotropic dissipation in equilibrium with the large eddies, $\varepsilon \sim q^3/l$}
...
\pb{9.43}{11.15}{3.6}{5.9}{row}{\textbf{Wall value of $\qsq$}\\ $\qsq = B_1^{2/3} u_*^2$ at the ground: the neutral level-2 equilibrium of the constant-flux layer}
\pbf{11.35}{13.05}{3.6}{5.9}{row}{\textbf{Level-2.5 truncation}\\ all moments but $\qsq$ algebraic; $S_M$, $S_H$ from the level-2 balance in the vertical Ri alone; cutoff at $\Rfc$}{0.44}
\pb{13.25}{14.40}{3.6}{5.9}{row}{\textbf{Surface fluxes and first level}\\ bulk transfer between the ground and $z_1$, which lies in the inertial sublayer: $z_0 \ll z_1 \ll z_i$}
\pbf{14.60}{17.20}{3.6}{5.9}{row}{\textbf{Master length scale}\\ $1/L = 1/L_S + 1/L_T + 1/L_B$ with universal coefficients: wall distance with $\zeta$, one $z_i$ per column, $q/N$; the same $L$ in $K$ and $\varepsilon$; blind to terrain and grid}{0.44}
\pb{17.40}{18.30}{3.6}{5.9}{row}{\textbf{Constant set}\\ one set, fitted over flat terrain}
\pb{18.50}{20.42}{3.6}{5.9}{row}{\textbf{Dissipation}\\ $\varepsilon = q^3/(B_1 L)$: isotropic, one rate, diagnosed from the master length}
...
\hl{11.35}{13.05}{3.6}{5.9}{cFULL}{0.05}\hl{11.35}{13.05}{3.6}{5.9}{cGXIX}{0.14} % level-2.5 truncation (cutoff)
\hl{14.60}{17.20}{3.6}{5.9}{cFULL}{0.05}\hl{14.60}{17.20}{3.6}{5.9}{cGXIX}{0.14} % master length scale
