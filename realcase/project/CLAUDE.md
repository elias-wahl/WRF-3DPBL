...
2. **Lead problem (2026-09-18):** in the afternoon a shallow (0–150 m AGL) northerly over-runs the northern-range crests and
   ...
   (+3.6…+3.9 K at 0–100 m by 01 UT at RADFELD by the HATPRO; +2.3…+2.4 K at 0–300 m at Kolsass by the 05 UT sonde —
   the HATPRO stood at Radfeld, not Kolsass: `KNOWN_ISSUES.md` E72). Excluded by runs: closure, roughness up to 0.2 m, land-cover heat partition,
