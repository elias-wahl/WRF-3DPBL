...
**Corrected 15:20 2026-09-26:** the interior mixing of θm is consistent; the defect is the surface boundary condition only (`wth`, and `wthv` lacks 0.61·θ·E/ρ) — a column sink 1.61·θ·E spread like a reduced sensible heat flux, not a cooling where the moisture flux converges. Size (HERO2, ∫ from 05 UT, spread over 1–1.5 km): 0.3–0.8 K by 13 UT day 1, 0.6–1.3 K by 14 UT day 2 (upper bound). The fix warms the daytime boundary layer (valley already 1–3 K too warm at 11 UT day 2). Not a first-order cause of the cloud errors (MYNN twins share them). DECISIONS 2026-09-26 15:20.
